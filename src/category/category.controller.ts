...
export class CategoryController {
  ...
  @Patch('large/:id')
  @HttpCode(200)
  async updateLargeCategory(@Param('id') id: number, @Body() data: LargeCategoryDto): Promise<IMessage> {
  ...
  @Patch('/small/:id')
  @HttpCode(200)
  async updateSmallCategory(@Param('id') id: number, @Body() data: SmallCategoryDto): Promise<IMessage> {
