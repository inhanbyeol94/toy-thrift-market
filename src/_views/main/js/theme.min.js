// 브라우저 콘설에 igzoom 오류 뜨길래 템플릿 관련이라 일단 주석처리
  ...
  null != (r = document.querySelector('.navbar-sticky')) &&
    ...
    (function () {
      for (var e = document.querySelectorAll('.image-zoom'), t = 0; t < e.length; t++)
        new Drift(e[t], { paneContainer: e[t].parentElement.querySelector('.image-zoom-pane') });
    })(),
    (function () {
    ...
    (function () {
      for (var o = document.querySelectorAll('[data-bs-toggle="select"]'), a = 0; a < o.length; a++)
        !(function () {
          for (
            var e = o[a].querySelectorAll('.dropdown-item'), t = o[a].querySelector('.dropdown-toggle-label'), r = o[a].querySelector('input[type="hidden"]'), n = 0;
            n < e.length;
            n++
          )
