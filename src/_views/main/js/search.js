          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-grid-gutter">
            <div class="card product-card-alt">
              <div class="product-thumb">
                <a class="product-thumb-overlay" href="/product/${info.id}"></a><img src="${
                  info.productImages[0].imageUrl
              ...
              <div class="card-body">
                ...
                <h3 class="product-title fs-sm mb-2"><a href="/product/${info.id}">${info.name}</a></h3>
